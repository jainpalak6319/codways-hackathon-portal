...
import { 
  ...
  Clock, Mail, ExternalLink, Award, ArrowRight 
} from 'lucide-react';
    ...
    <>
      <style>
        {`
          ...
          .tech-grid-bg {
            background-image: linear-gradient(to right, #1C2B42 1px, transparent 1px), linear-gradient(to bottom, #1C2B42 1px, transparent 1px);
          ...
          .btn-register:hover {
            ...
            box-shadow: 0 0 30px rgba(0, 194, 178, 0.5);
          }
          ...
          .custom-timeline::before {
            ...
            position: absolute;
            top: 0; bottom: 0;
            left: 1.375rem; /* Approx center of the 44px dot */
            width: 4px;
            background: linear-gradient(to bottom, #00C2B2, rgba(0, 194, 178, 0.5), #E2E8F0);
            border-radius: 4px;
          ...
          @media (min-width: 768px) {
            ...
            .timeline-item:hover:nth-child(odd) .timeline-dot {
              transform: translateX(-50%) scale(1.1);
            }
            .timeline-item:hover:nth-child(even) .timeline-dot {
              transform: translateX(50%) scale(1.1);
            }
      ...
      <div className="container-xl hackathon-details pb-5 pt-3">
        ...
        {/* ================= HERO SECTION (FIXED COMPACT LAYOUT) ================= */}
        <div className="hero-section position-relative rounded-4 mb-5 overflow-hidden">
          ...
          {/* Content Container - Compact Vertical Padding (py-4) */}
          <div className="position-relative z-1 py-2 px- px-md-5">
            <div className="row align-items-center justify-content-between g-4">
              
              {/* Left Column: Text & Badges - UPDATED TO col-lg-8 */}
              <div className="col-12 col-lg-8">
                <div className="d-flex align-items-center gap-3 mb-2">
                  <div className="position-relative d-flex" style={{ width: '10px', height: '10px' }}>
                    <span className="position-absolute w-100 h-100 rounded-circle animate-custom-ping" style={{ backgroundColor: '#00C2B2', opacity: '0.75' }}></span>
                    <span className="position-relative w-100 h-100 rounded-circle" style={{ backgroundColor: '#00C2B2' }}></span>
                  </div>
                  <span 
                    className="px-3 py-1 rounded-pill fw-bold text-uppercase" 
                    style={{ fontSize: '11px', letterSpacing: '0.15em', color: '#00C2B2', backgroundColor: 'rgba(0,194,178,0.1)', border: '1px solid rgba(0,194,178,0.2)', boxShadow: '0 0 15px rgba(0,194,178,0.1)' }}
                  >
                ...
                {/* Quick Stats Banner - Tighter Top Margin */}
                <div className="d-flex flex-wrap align-items-center gap-3 mt-4 pt-3 border-top" style={{ borderColor: 'rgba(28,43,66,0.6) !important' }}>
                  <div className="hero-stat-badge d-flex align-items-center gap-2 px-3 py-2 rounded-3">
                    ...
                    <span className="fw-semibold" style={{ fontSize: '13px' }}>Jul 03 - Jul 15</span>
                  </div>
                  <div className="hero-stat-badge d-flex align-items-center gap-2 px-3 py-2 rounded-3">
                    <MapPin size={16} color="#8B5CF6" />
                    <span className="fw-semibold" style={{ fontSize: '13px' }}>Hybrid Mode</span>
                  </div>
                  <div className="hero-stat-badge d-flex align-items-center gap-2 px-3 py-2 rounded-3">
                    <Trophy size={16} className="text-warning" />
                    <span className="fw-semibold" style={{ fontSize: '13px' }}>₹50,000 Prize</span>
                  </div>
                </div>
              </div>
              
              {/* Right Column: Call to Action Panel - UPDATED TO col-lg-4 */}
              <div className="col-12 col-lg-4 d-flex justify-content-lg-end">
                {/* Slimmer Glass Panel Padding */}
                <div className="hero-glass-panel d-flex flex-column align-items-center p-3 px-md-4 py-md-4 rounded-4 w-100" style={{ maxWidth: '350px' }}>
                  <p className="fw-bold text-uppercase text-center mb-1 w-100" style={{ fontSize: '11px', letterSpacing: '0.15em', color: '#8A99AF' }}>
                    Registration Closes In
                  </p>
                  <div className="fw-black text-white mb-3 tracking-wider" style={{ fontSize: '1.5rem' }}>
                    12<span className="mx-1" style={{ color: '#00C2B2' }}>:</span>45<span className="mx-1" style={{ color: '#00C2B2' }}>:</span>30
                  </div>
                  ...
                  <button 
                    ...
                    onClick={() => navigate(`/participant/register/${hackathonData.id}`, { 
        ...
        <div className="row g-4 g-lg-5">
          ...
          <div className="col-12 col-lg-8 d-flex flex-column gap-4 gap-md-5">
            ...
            <div className="content-card p-4 p-md-5 rounded-4">
              ...
              <p className="text-body-custom fw-medium lh-lg mb-5">{hackathonData.overview}</p>
              ...
              <div className="mt-5 pt-4 border-top border-custom">
                <h3 className="fs-5 fw-bold text-dark-custom mb-3">Eligibility</h3>
                <div className="d-flex flex-wrap gap-2">
                  {hackathonData.eligibility.map((item, i) => (
                    <span key={i} className="px-3 py-2 rounded-3 fw-semibold border border-custom" style={{ backgroundColor: '#F8FAFC', color: '#4F627D', fontSize: '14px' }}>
                      {item}
                    </span>
                  ))}
                </div>
            ...
            <div className="content-card p-4 p-md-5 rounded-4">
              ...
              <div className="custom-timeline d-flex flex-column gap-4 gap-md-5">
                {hackathonData.stages.map((stage) => (
                  <div key={stage.id} className="timeline-item d-flex align-items-center justify-content-between justify-content-md-start position-relative">
                    
                    {/* Timeline Dot */}
                    <div className="timeline-dot d-flex align-items-center justify-content-center rounded-circle flex-shrink-0">
                      <span className="fw-bold fs-6">{stage.id}</span>
                    </div>
              ...
              <div className="d-flex flex-column gap-4">
                <div className="d-flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="fw-semibold text-dark-custom mb-0">{hackathonData.quickStats.location}</p>
                  </div>
                </div>
                <div className="d-flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="fw-semibold text-dark-custom mb-0">{hackathonData.quickStats.teamSize}</p>
                  </div>
                </div>
                <div className="d-flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="fw-black text-dark-custom fs-5 mb-0">{hackathonData.quickStats.prizePool}</p>
                  </div>
                </div>
                <div className="d-flex align-items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="fw-semibold text-dark-custom mb-0">{hackathonData.quickStats.registrationEnds}</p>
                  </div>
                </div>
              </div>
            </div>
